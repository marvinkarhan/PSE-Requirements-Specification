...
\input{kapitel/the-purpose-of-the-project.tex}
\input{kapitel/the-stakeholders.tex}
\input{kapitel/constraints.tex}
\input{kapitel/relevant-facts-and-assumptions.tex}
\input{kapitel/the-scope-of-the-work.tex}
\input{kapitel/the-scope-of-the-product.tex}
\input{kapitel/functional-requirements.tex}
\input{kapitel/look-and-feel-requirements.tex}
\input{kapitel/usability-and-humanity-requirements.tex}
\input{kapitel/performance-requirements.tex}
\input{kapitel/security-requirements.tex}
\input{kapitel/open-issues.tex}
\input{kapitel/off-the-shelf-solutions.tex}
\input{kapitel/project-planning.tex}
\input{kapitel/risks.tex}
\input{kapitel/outlook.tex}
% \input{kapitel/ideas-for-soluitions.tex}
% ------------------------------------------------------------------
