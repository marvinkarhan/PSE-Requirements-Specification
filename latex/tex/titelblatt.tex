...
\noindent\includegraphics[width=.45\columnwidth]{hsma-logo.pdf}\hfill
\noindent\includegraphics[width=.45\columnwidth]{caruso_logo_rgb.png}\\
...
\newcommand{\snowcard}[9]{
  \begin{table}[ht!]
    ...
    \caption{\hsmasnowcardanforderung\ NFR{\arabic{snowcardcounter}} -- #3}\label{NFR{\arabic{snowcardcounter}}}
    \centering
    \sffamily
    \begin{footnotesize}
    \begin{tabularx}{\linewidth}{sssssb}
    \toprule
    \textbf{\hsmasnowcardno} & NFR{\arabic{snowcardcounter}} & \textbf{\hsmasnowcardart} & #1 & \textbf{\hsmasnowcardprio} & #2 \\
    \midrule
